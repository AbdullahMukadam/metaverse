...
function SignupComponent() {
    ...
    return (
        <div onClick={signUp} className='w-full h-[80%] flex items-center justify-center flex-col font-michroma p-2 bg-gradient-to-br from-[#C4C4C4] via-slate-200 to-[#F2F2F2] rounded-2xl border-2 border-black'>
            ...
            <div className='w-full flex items-center justify-center flex-col mt-2 gap-2'>
                <button className='p-2 rounded-lg border-[2px] flex w-[250px] items-center justify-center gap-3 cursor-pointer transition-all duration-300 ease-in-out hover:bg-zinc-950 hover:text-white'>
