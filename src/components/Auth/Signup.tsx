...
function SignupComponent() {
    ...
    const githubSignup = useCallback(async () => {
        try {
            ...
            if (response.error) {
                toast("User Cancelled the signup")
    ...
    return (
        <div className='w-full h-[80%] flex items-center justify-center flex-col font-michroma p-2 bg-gradient-to-br from-[#C4C4C4] via-slate-200 to-[#F2F2F2] rounded-2xl border-2 border-black'>
            ...
            <div className='w-full flex items-center justify-center flex-col mt-2 gap-2'>
                <button onClick={githubSignup} className='p-2 rounded-lg border-2 border-black flex w-[250px] items-center justify-center gap-3 cursor-pointer transition-all duration-300 ease-in-out hover:bg-zinc-950 hover:text-white'>
                ...
                <button className='p-2 rounded-lg border-2 border-black flex w-[250px] items-center justify-center gap-3 cursor-pointer transition-all duration-300 ease-in-out hover:bg-zinc-950 hover:text-white'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><g fill="none" fillRule="evenodd"><path d="m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z" /><path fill="currentColor" d="M12 5.5a6.5 6.5 0 1 0 6.326 8H13a1.5 1.5 0 0 1 0-3h7a1.5 1.5 0 0 1 1.5 1.5a9.5 9.5 0 1 1-2.801-6.736a1.5 1.5 0 1 1-2.116 2.127A6.48 6.48 0 0 0 12 5.5" /></g></svg>
                    <p>Google</p>
                </button>
            </div>
